/**
 * HydroIoT NODE 3 — Hydroponic B
 * TX setiap 7 detik ke Gateway via LoRa E32
 *
 * IDENTIK dengan Node 2 kecuali:
 *   - NODE_ADDL = 0x03 (Node 2 = 0x02)
 *   - Label LCD/Serial: "Node3"
 *
...
// ─── Pin Definitions (SAMA dengan Node 2) ───────────────────
#define AUX_PIN   18
#define M0_PIN    21
#define M1_PIN    22
#define RX_PIN    16
...
void setup() {
  ...
  lcd.setCursor(0, 0); lcd.print("Node3 Init...");
